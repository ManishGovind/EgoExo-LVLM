...
from ego_exo_video_chatgpt.inference import video_chatgpt_infer , ego_exo_video_chatgpt_infer
...
def run_inference(args):
    ...
    for video_id, sample in tqdm(gt_contents.items()):
        ...
        try:
            ...
            output_1 = ego_exo_video_chatgpt_infer(video_frames, question_1, conv_mode, model, vision_tower,
            ...
            output_2 = ego_exo_video_chatgpt_infer(video_frames, question_2, conv_mode, model, vision_tower,
                                             tokenizer, image_processor, video_token_len)
