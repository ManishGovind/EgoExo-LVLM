            ...
            try:
                if args.ego_exo :
                    if args.dual_projection == "both":
                        prediction = ego_exo_video_chatgpt_infer(video_frames, formatted_question, conv_mode, model, vision_tower, tokenizer, image_processor, video_token_len)
                    else:
                        prediction = video_chatgpt_infer(video_frames, formatted_question, conv_mode, model, vision_tower, tokenizer, image_processor, video_token_len,False)     
                else:    
